  ...
  return (
    <div className="flex">
      {pathname !== "/" ? (
        ...
        >
          <IconArrowLeft stroke={1.5} className="h-5 w-5" aria-hidden="true" />
        </Link>
      ) : null}
      ...
      <div className="relative flex-1">
        ...
        {isPending ? (
          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3">
            <IconLoader2 stroke={1.5} className="h-5 w-5 animate-spin" aria-hidden="true" />
          </div>
        ) : query ? (
          <button
            ...
            onClick={reset}
          >
            <IconX stroke={1.5} className="h-5 w-5" aria-hidden="true" />
          </button>
        ) : null}
      </div>
    </div>
